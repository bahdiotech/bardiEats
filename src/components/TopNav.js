  ...
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
       ...
       <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Bardi
       ...
       <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
        <AiOutlineSearch />
        <input className='bg-transparent inputt focus:outline-none focus:border-none outline-0 border-none p-2 w-full  ' type="text" placeholder='search meals'/>
       </div>
